                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="border rounded">
                                    <a href="#">
                                        <img src="{{ $product->fileURL() }}" class="img-fluid rounded" alt="{{ $product->name }}">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                ...
                <div class="vesitable">
                    <div class="owl-carousel vegetable-carousel justify-content-center">
                        ...
                        <div class="border border-primary rounded position-relative vesitable-item">
                            ...
                            <div class="text-white bg-primary px-3 py-1 rounded position-absolute" style="top: 10px; right: 10px;">{{ $product->categorieString() }}</div>
